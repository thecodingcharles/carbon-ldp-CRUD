...
exports.URI = {
    ...
    getDocumentURI: function (uri) {
        var parts = uri.split("#");
        if (parts.length > 2)
            throw new IllegalArgumentError_1.IllegalArgumentError("The URI provided has more than one # sign.");
        return parts[0];
    },
    getFragment: function (uri) {
        var parts = uri.split("#");
        if (parts.length < 2)
            throw new IllegalArgumentError_1.IllegalArgumentError("The URI provided hasn't a # sign.");
        if (parts.length > 2)
            throw new IllegalArgumentError_1.IllegalArgumentError("The URI provided has more than one # sign.");
        return parts[1];
    },
