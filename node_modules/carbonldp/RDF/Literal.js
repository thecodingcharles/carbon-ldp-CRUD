...
var Serializers = tslib_1.__importStar(require("./Literal/Serializers"));
    ...
    parse: function (valueOrLiteral, type) {
        ...
        switch (type) {
            ...
            case XSD_1.XSD.time:
                ...
                if (!parts)
                    throw new IllegalArgumentError_1.IllegalArgumentError("Invalid value for type " + XSD_1.XSD.time + ".");
                value = new Date();
