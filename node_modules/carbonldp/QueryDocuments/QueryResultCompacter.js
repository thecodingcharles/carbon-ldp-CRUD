...
var QueryableProperty_1 = require("./QueryableProperty");
var QueryableRootProperty_1 = require("./QueryableRootProperty");
...
var QueryResultCompacter = (function () {
    ...
    QueryResultCompacter.prototype.compactDocuments = function (rdfDocuments, targetDocuments) {
        ...
        rdfDocuments.forEach(function (rdfDocument) {
            ...
            if (!document.$_queryableMetadata) {
                document.$_queryableMetadata = new QueryableRootProperty_1.QueryableRootProperty({
                    uri: document.$id,
        ...
        targetDocuments.forEach(function (documentID) {
            ...
            if (!compactionNode)
                throw new IllegalArgumentError_1.IllegalArgumentError("Invalid data provided.");
        ...
        compactionMap.forEach(function (_a) {
            ...
            var _b;
            if (!isCompacted) {
                var targetNode = tslib_1.__assign({}, node, (_b = {}, _b[C_1.C.document] = undefined, _b[C_1.C.checksum] = undefined, _b));
        ...
        rdfDocuments
            ...
            .filter(Utils_1._isExistingValue)
            .forEach(function (_a) {
            var resource = _a.resource, node = _a.node;
            resource.$_syncSnapshot();
            var rawValues = node[C_1.C.checksum];
            if (!rawValues || typeof rawValues === "string")
                return;
            var eTag = Node_1.RDFNode.getPropertyLiterals(rawValues, XSD_1.XSD.string)[0];
            if (!eTag)
                return;
            resource.$eTag = "\"" + eTag + "\"";
    ...
    QueryResultCompacter.prototype.__processNode = function (compactionMap, compactionNode, queryProperty, metadataProperty) {
        ...
        var targetNode = tslib_1.__assign({}, node, (_a = {}, _a[C_1.C.document] = undefined, _a[C_1.C.checksum] = undefined, _a));
            ...
            values.forEach(function (value) {
                ...
                if (subCompactionNode.resource.$_queryableMetadata) {
                    ...
                    if (subCompactionNode.document === document) {
                        ...
                        subCompactionNode.resource.$_queryableMetadata = new QueryableProperty_1.QueryableProperty({
                            propertyType: subMetadataProperty.propertyType,
                            optional: subMetadataProperty.optional,
                            definition: Object.assign(new DigestedObjectSchemaProperty_1.DigestedObjectSchemaProperty(), subMetadataProperty.definition, {
                                uri: null,
                            }),
                        });
                        subMetadataProperty.propertyType = void 0;
...
exports.QueryResultCompacter = QueryResultCompacter;
