...
var PathsBuilder_1 = require("./paths/PathsBuilder");
...
exports.PatternBuilder = {
    ...
    createFrom: function (container, object) {
        return Factory_1.Factory.createFrom(TriplePatternsBuilder_1.TriplePatternsBuilder.createFrom, NotTriplePatternsBuilder_1.NotTriplePatternsBuilder.createFrom, SubSelectPattern_1.SubSelectPattern.createFrom, PathsBuilder_1.PathsBuilder.createFrom)(container, object);
    },
};
