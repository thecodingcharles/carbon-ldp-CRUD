 ...
 */
export declare type NotTripleToken = GroupPatternToken | UnionPatternToken | MinusPatternToken | ServicePatternToken | OptionalToken | GraphToken | BindToken | FilterToken | ValuesToken;
