 ...
 */
export declare class QueryUnitContainer<SELECT extends FinishClause, ASK extends FinishClause> extends Container<QueryToken> implements QueryUnitContainerData<SELECT, ASK> {
    /**
