...
var AskClause_1 = require("./AskClause");
...
exports.QueryClause = {
    createFrom: function (container, object) {
        ...
        var askFactory = AskClause_1.AskClause
            .createFrom.bind(null, container.askFinishClauseFactory);
        return Factory_1.Factory.createFrom(selectFactory, askFactory)(container, Object.assign(object, {
