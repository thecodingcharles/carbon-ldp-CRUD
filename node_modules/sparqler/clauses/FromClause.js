...
function getFromFn(genericFactory, container, named) {
    return function (iri) {
        ...
        var datasets = container.targetToken.queryClause.datasets
            .concat(new FromToken_1.FromToken(iriResolver.resolve(iri), named));
        var queryClause = utils_1.cloneElement(container.targetToken.queryClause, { datasets: datasets });
